            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href={{ route('admin.rooms.create') }} class="btn btn-primary admin-add-button">
                ...
                <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" id="rooms-table">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Area</th>
