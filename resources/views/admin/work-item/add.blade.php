    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                ...
                {!! Form::open(['route' => 'admin.work-items.store', 'id' => 'work-item-form']) !!}
                    <div class="row">
                        <div class="col-md-6">
...
<script>
    ...
    $('form#work-item-form').submit(function(e){
        ...
        $('form#work-item-form #add-button').text('Adding...').prop('disabled', true);
        ...
        $.ajax({
            ...
            complete: function()
            {
                $('form#work-item-form #add-button').text('Add').prop('disabled', false);
            }
        });
    });
    ...
    $('#type_id').change(function(event) {
        ...
        if(type == "")
        {
            ...
            // $('#sub-type-anchor').attr('onclick', 'return false');           
        }
        else
        {   
